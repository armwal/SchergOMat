...
namespace Chummer.Skills
{
	public class SkillsSection : INotifyPropertyChanged
	{
		...
		internal void Load(IXmlNode skillNode, bool legacy = false)
		{
		...
		public ObservableCollection<KnowledgeSkill> KnowledgeSkills { get; } = new ObservableCollection<KnowledgeSkill>();
		...
		/// Skill Groups.
		/// </summary>
		public ObservableCollection<SkillGroup> SkillGroups { get; } = new ObservableCollection<SkillGroup>();
